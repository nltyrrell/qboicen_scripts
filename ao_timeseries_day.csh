...
# Usage:
# $ ao_pattern_mon.ksh --group=$group --model=$model --exp=$exp --tmean=$tmean --real=$real --punits=$punits --years=$years --model_dir=$model_dir --model_filename=$model_filename
# 
...
eofin_filename="eof1_mon_${group}${model}_QBOi${exp}_${real}_${tmean}.nc"
...
cdo -chname,var7,ao -fldmean ${out_tempfile}_proj1_mon.nc ${out_tempfile}_ao_nostd_mon.nc
...
rm ${out_tempfile}_proj1_mon.nc ${out_tempfile}_ao_nostd_mon.nc # remove some files after having a quick look at them

...
plev="700"	# pressure level in Pa (not hPa!)
...
plev="100000"	# pressure level in Pa (not hPa!)
...
plev="10000"	# pressure level in Pa (not hPa!)
...
plev="10000,8500,7000,6000,5000,4000,3000,2000,1500,1000"	# pressure level in Pa (not hPa!)
lon_min="0"	# Minimum longitude
lon_max="360"	# Maximum longitude

...
$script_dir/cdo_master.sh --group=$group --model=$model --exp=$exp --tmean=$tmean --real=$real --punits=$punits --years=$years --model_dir=$model_dir --model_filename=$model_filename --lat_size=$lat_size --actor_dir=$actor_dir --qbo_plev=$qbo_plev
...
lat_size="48"; qbo_plev="7"; punits=""	
$script_dir/cdo_master.sh --group=$group --model=$model --exp=$exp --tmean=$tmean --real=$real --punits=$punits --model_dir=$model_dir --model_filename=$model_filename --lat_size=$lat_size --actor_dir=$actor_dir --make_actor_dir=$make_actor_dir --qbo_plev=$qbo_plev
$script_dir/combine_actors.py "${group}${model}" "${exp}" "${real}" "${tmean}"
...
$script_dir/cdo_master.sh --group=$group --model=$model --exp=$exp --tmean=$tmean --real=$real --punits=$punits --model_dir=$model_dir --model_filename=$model_filename --lat_size=$lat_size --actor_dir=$actor_dir --make_actor_dir=$make_actor_dir --merge_time=$merge_time --mirocapsl_merge_time=$mirocapsl_merge_time --qbo_plev=$qbo_plev
$script_dir/combine_actors.py "${group}${model}" "${exp}" "${real}" "${tmean}"
real="r3i1p1"
group="MIROC"; model="MIROC-AGCM"
model_dir="/gws/nopw/j04/qboi/${group}/${model}/${model}-LL/QBOi${exp}/${tmean}/atmos"
...
real="r3i1p1"
group="MOHC"; model="UMGA7"; years="197901-200912"
model_dir="/gws/nopw/j04/qboi/${group}/${model}/QBOi${exp}/${tmean}/atmos"
...
$script_dir/cdo_master.sh --group=$group --model=$model --exp=$exp --tmean=$tmean --real=$real --punits=$punits --model_dir=$model_dir --model_filename=$model_filename --lat_size=$lat_size --actor_dir=$actor_dir --qbo_plev=$qbo_plev
$script_dir/combine_actors.py "${group}${model}" "${exp}" "${real}" "${tmean}"
real="r3i1p1"
group="WACCM"; model=""
model_dir="/gws/nopw/j04/qboi/${group}/${model}/QBOi${exp}/${tmean}/atmos"

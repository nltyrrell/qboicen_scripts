...
years="197001-199912" # Exp1: 197901-200912 Exp2: 000101-003112
model_dir="/gws/nopw/j04/qboi/${group}/${model}/QBOi${exp}/${tmean}/atmos"
...
$script_dir/cdo_master.sh --group=$group --model=$model --exp=$exp --tmean=$tmean --real=$real --punits=$punits --years=$years --model_dir=$model_dir --model_filename=$model_filename --lat_size=$lat_size --actor_dir=$actor_dir --make_actor_dir=$make_actor_dir --merge_time=$merge_time
...
punits="00"	# Add "00" if pres levs in Pa, empty string if hPa
years="197901-208402" # Exp1: 197901-200912 Exp2: 000101-003112
model_dir="/gws/nopw/j04/qboi/${group}/${model}/QBOi${exp}/${tmean}/atmos"
...
real="r1i1p1"	# realisation number, r1i1p1, r2i1p1, r3i1p1
punits="00"	# Add "00" if pres levs in Pa, empty string if hPa
years="000301-003212" # Exp1: 197901-200912 Exp2: 000101-003112
model_dir="/gws/nopw/j04/qboi/${group}/${model}/QBOi${exp}/${tmean}/atmos"

...
# This script runs the CDO commands for all models, using naosimp_master.sh

#
#============
# Use naosimp_master.sh to get the timeseries for all models
# naosimp_master.sh.sh script is:
...
$script_dir/naosimp_master.sh --group=$group --model=$model --exp=$exp --tmean=$tmean --real=$real --punits=$punits --years=$years --model_dir=$model_dir --model_filename=$model_filename --lat_size=$lat_size --actor_dir=$actor_dir --make_actor_dir=$make_actor_dir
...
$script_dir/naosimp_master.sh --group=$group --model=$model --exp=$exp --tmean=$tmean --real=$real --punits=$punits --years=$years --model_dir=$model_dir --model_filename=$model_filename --lat_size=$lat_size --actor_dir=$actor_dir --make_actor_dir=$make_actor_dir --merge_time=$merge_time
